...
class Cadastro
{
    ...
    public function cadastrar()
    {
        ...
        $sql = "INSERT INTO cadastro(NomeCompleto, NomeUsuario, Email, NumeroTelefone, Senha, ConfirmarSenha) 
                VALUES (:nomeCompleto, :nomeUsuario, :email, :numeroTelefone, :senha, :confirmarSenha)";
...
} elseif ($resultado === "Nome usuário já cadastrado.") {
